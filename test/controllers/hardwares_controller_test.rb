...
class HardwaresControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create hardware" do
    assert_difference('Hardware.count') do
      post hardwares_url, params: { hardware: { comment: @hardware.comment, component_type: @hardware.component_type, serial: @hardware.serial, status: @hardware.status } }
    end
  ...
  test "should update hardware" do
    patch hardware_url(@hardware), params: { hardware: { comment: @hardware.comment, component_type: @hardware.component_type, serial: @hardware.serial, status: @hardware.status } }
